...
class RoomMusicSeeked implements ShouldBroadcastNow
{
    ...
    public function __construct(
        ...
        AppUser $user,
        string $message = 'Music seek updated successfully'
    ) {
        $this->roomId = $roomId;
        $this->song = $song;
