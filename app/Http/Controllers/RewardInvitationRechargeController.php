...
use App\Models\RewardInvitationRecharge;
...
class RewardInvitationRechargeController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = RewardInvitationRecharge::select('id', 'deposit_amount', 'gain_benefits', 'status', 'created_at');
        ...
        return view('rewardnvitationrecharge.index');
    }

    public function add(): View
    {
        return view('rewardnvitationrecharge.add');
    }
