...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('family.level.privilege.edit', $privilege->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <div>
                        ...
                        <label for="level_badge"
                            ...
                            <img id="badgePreview"
                                class="position-absolute w-100 h-100 {{ $privilege->level_badge ? '' : 'd-none' }}"
                                style="object-fit:cover;"
                                src="{{ $privilege->level_badge ? Helper::showImage($privilege->level_badge, true) : '' }}">
                ...
                <div class="mb-4">
                    ...
                    <div>
                        ...
                        <label for="level_frame"
                            ...
                            style="width:150px;height:120px;cursor:pointer;overflow:hidden;">
                            <img id="framePreview"
                                class="position-absolute w-100 h-100 {{ $privilege->level_frame ? '' : 'd-none' }}"
                                style="object-fit:cover;"
                                src="{{ $privilege->level_frame ? Helper::showImage($privilege->level_frame, true) : '' }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="member"
                        ...
                        value="{{ old('member', $privilege->members) }}">
                    @error('member')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="admin"
                        ...
                        value="{{ old('admin', $privilege->admin) }}">
                    @error('admin')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('family.level.privilege', $privilege->family_level_id) }}" class="btn btn-secondary">Cancel</a>
