    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Coin Seller :: List</h5>
            </div>
...
<script>
    $(function () {
        ...
        // TOGGLE MERCHANT
        $(document).on('click', '.toggle-merchant', function () {
            let id = $(this).data('id');
            let type = $(this).data('type');

            Swal.fire({
                title: 'Are you sure?',
                text: type == 1 ? "Remove Merchant?" : "Make Merchant?",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    $.post("{{ route('coin_seller.toggleMerchant') }}", {
                        _token: "{{ csrf_token() }}",
                        id: id
                    }, function (res) {
                        if (res.status) {
