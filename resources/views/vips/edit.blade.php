    ...
    <div class="card-body">
        ...
        <form action="{{ route('vip.edit', $vip->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <label>Coins</label>
                    <input type="number" name="needcoins"
                        class="form-control @error('needcoins') is-invalid @enderror"
                        value="{{ old('needcoins',$vip->needcoins) }}">
                    @error('needcoins') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <input type="text" id="vip_color_text"
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex gap-2">
                        <input type="color" name="username" id="username"
                            class="color-picker" value="{{ $username }}">
            ...
            {{-- BADGE --}}
            <div class="section-title">Badge / Chat Card</div>
