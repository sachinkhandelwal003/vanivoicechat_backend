            ...
            <form action="{{ route('vip.add') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            value="{{ old('name') }}" placeholder="Enter VIP name">
                        @error('name')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="needcoins" class="form-control @error('needcoins') is-invalid @enderror"
                            value="{{ old('needcoins') }}" placeholder="Enter coins">
                        @error('needcoins')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="color" name="color" id="vip_color"
                                class="color-picker @error('color') is-invalid @enderror" value="{{ $selectedColor }}">

                            <input type="text" id="vip_color_text" class="form-control" value="{{ $selectedColor }}"
                                readonly>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="color" name="username" id="username"
                                class="color-picker @error('username') is-invalid @enderror" value="{{ $selectedColor }}">

                            <input type="text" id="username_text" class="form-control" value="{{ $selectedColor }}"
                                readonly>
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" name="title_tag"
                            class="form-control image-input @error('title_tag') is-invalid @enderror" accept="image/*">
                        @error('title_tag')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" name="badge"
                            class="form-control image-input @error('badge') is-invalid @enderror" accept="image/*">
                        @error('badge')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="file" name="entry_tag"
                            class="form-control image-input @error('entry_tag') is-invalid @enderror" accept="image/*">
                        @error('entry_tag')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" name="entry_tag_animation"
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="img_key" class="form-control @error('img_key') is-invalid @enderror"
                            value="{{ old('img_key') }}" placeholder="Example: user_image">
                        @error('img_key')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="text_key"
                            class="form-control @error('text_key') is-invalid @enderror" value="{{ old('text_key') }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="frame_key"
                            class="form-control @error('frame_key') is-invalid @enderror" value="{{ old('frame_key') }}"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="file" name="image_frame"
                            class="form-control image-input @error('image_frame') is-invalid @enderror" accept="image/*">
                        @error('image_frame')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" name="image_frame_animation"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="file" name="profile_frame"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" name="profile_frame_animation"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="file" name="voice_frame"
                            class="form-control image-input @error('voice_frame') is-invalid @enderror" accept="image/*">
                        @error('voice_frame')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" name="voice_animation"
                            class="form-control @error('voice_animation') is-invalid @enderror" accept="image/*,.svga">
