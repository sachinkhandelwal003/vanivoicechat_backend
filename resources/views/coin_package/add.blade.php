...
<div class="container-fluid py-2">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-primary text-white fw-bold d-flex align-items-center justify-content-between py-3">
            <span class="fs-6"><i class="fas fa-coins me-2"></i>Add Coin Package</span>
            ...
            <form action="{{ route('coin.package.add') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group mb-1">
                            <span class="input-group-text" id="currency-preview-addon"><i class="fas fa-money-bill-wave text-info"></i></span>
                            <input type="text" name="currency_symbol" id="currency_symbol_input"
                                class="form-control @error('currency_symbol') is-invalid @enderror"
                                placeholder="e.g. $ or ₹ or €"
                                value="{{ old('currency_symbol', '$') }}" maxlength="10" required>
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex align-items-start gap-3">
                        <input type="file" name="icon" id="icon" class="d-none" accept="image/*" required>
                        ...
                        <label for="icon"
                            ...
                            <div id="coverPlus" class="text-center text-muted">
                        ...
                        <div>
                            <small class="d-block text-muted mb-1">
                                <i class="fas fa-info-circle me-1"></i> Recommended format: PNG, JPG, WEBP
                            </small>
                ...
                <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary px-4 fw-semibold">
                        <i class="fas fa-save me-1"></i> Save Coin Package
                    </button>
                </div>
