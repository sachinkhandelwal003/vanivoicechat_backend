...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">Broadcast Price :: Broadcast Price Add </h5>
            </div>
    ...
    <div class="card-body">
        <form class="row" id="add" method="POST" action="{{ route('broadcast-price.add') }}" enctype='multipart/form-data'>
            @csrf
