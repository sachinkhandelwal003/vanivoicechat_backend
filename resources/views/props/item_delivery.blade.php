            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('props.delivery.store') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <button type="button" id="openModalBtn" class="btn btn-outline-primary" disabled
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center mt-3">
                        <button id="loadMoreBtn" class="btn btn-outline-secondary d-none"
                            style="color:black !important">Load More</button>
                    </div>
            ...
            fetch(`/props/get-items/${encodeURIComponent(selectedType)}?page=${page}&search=${search}`)
                ...
                .then(data => {
                    ...
                    data.data.forEach(item => {
                        ...
                        if (item.type === 'image') {
                            preview =
                                `<img src="${item.preview}" class="img-fluid rounded mb-1" style="width:100px; height:100px">`;
