...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('premium_number.edit', $pNumber->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- <div class="mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="premium_number"
                            value="{{ old('premium_number', $pNumber->premium_number) }}"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="valid_days"
                            value="{{ old('valid_days', $pNumber->valid_days) }}"
